        ...
        Ok(report) => {
            ...
            json_tool_response(
                ...
                json!({
                    ...
                    "recallProvider": report.recall_provider,
                    "recallBackend": report.backend,
                    "retrievalBackend": report.retrieval_backend,
                    "fallbackUsed": report.fallback_used,
                    "fallbackBackend": report.fallback_backend,
                    "fallbackReason": report.fallback_reason,
                    "lastMemEngineReceiptId": report.last_mem_engine_receipt_id,
