...
- A CLI crate with `doctor`, `import-plan`, `import-dry-run`, `import-execute`, `registry`, `registry-export`, `skills`, `turn-plan`, `prompt-bundle`, `cron-plan`, and `deterministic-cron-plan` commands.
